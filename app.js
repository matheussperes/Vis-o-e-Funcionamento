/* ════════════════════════════════════════════════════════════════
   ...
   Fase 3 do plano (seção 23): B7 Ritual (T-09) · B8 Semana (T-04) ·
   B9 Relatório (T-08) — somadas a B1–B6 das Fases 1 e 2.
   ════════════════════════════════════════════════════════════════ */
...
function desenharRitual(ctx) {
  ...
  /* Fila sugerida: abertas ainda sem pin e sem alocação amanhã, ordem RN-01 */
  const sugeridas = ctx.tarefas
